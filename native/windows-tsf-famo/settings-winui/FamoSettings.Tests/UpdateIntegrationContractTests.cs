...
public sealed class UpdateIntegrationContractTests
{
    ...
    public void ReleaseMetadataIsPreparedFor1512()
    {
        ...
        Assert.Contains("[string] $AppVersion = '1.5.12'", build);
        Assert.Contains("[string] $AppVersion = '1.5.12'", appcast);
        Assert.Contains("#define AppVersion  \"1.5.12\"", installer);
        Assert.Contains("\"versionInfo\": \"1.5.12\"", sbom);
    }
